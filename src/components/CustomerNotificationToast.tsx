...
import { CheckCircle2, Truck, Bell, X, Sparkles, ShoppingBag } from 'lucide-react';
...
export default function CustomerNotificationToast({
  ...
  // Auto-dismiss after 8 seconds and trigger mobile vibration on display
  useEffect(() => {
    if (!notification) return;

    // Trigger gentle vibration on mobile devices if supported
    ...
    <AnimatePresence>
      {notification && (
        <motion.div
          ...
          className="fixed top-3 sm:top-5 left-1/2 -translate-x-1/2 z-[9999] w-[94%] max-w-md pointer-events-auto"
        >
          <div
